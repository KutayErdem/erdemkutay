...
public class MathActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (sharedpreferences.contains(username.getText().toString()) &&
                    ...
                    if (sharuser.equals(sharpass)) {
                        ...
                        startActivity(new Intent(MathActivity.this, LoginMathActivity.class)
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MathActivity.this, SignActivity.class));
            }
        });
    }
    ...
    private void populateRecyclerView() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewOnClickListener(this, new RecyclerViewOnClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(MathActivity.this, YoutubePlayerActivity.class)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mathematics) {
            startActivity(new Intent(MathActivity.this, MathActivity.class));
        } else if (id == R.id.nav_engineering) {
            startActivity(new Intent(MathActivity.this, EngineeringActivity.class));
        } else if (id == R.id.nav_science) {
            startActivity(new Intent(MathActivity.this, ScienceActivity.class));
            ...
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ActivityCompat.finishAffinity(MathActivity.this);
                }
            });

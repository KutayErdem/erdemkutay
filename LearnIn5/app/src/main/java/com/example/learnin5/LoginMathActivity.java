...
public class LoginMathActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_math);
        setUpRecyclerView();
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                startActivity(new Intent(LoginMathActivity.this, MathActivity.class));
            }
        });
    }
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewOnClickListener(this, new RecyclerViewOnClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (isfavs.contains( _username + _password + youtubeVideoModelArrayList.get(position).getVideoId())){
                    startActivity(new Intent(LoginMathActivity.this, FavoritesPlayerActivity.class)
                            ...
                            .putExtra("activity_name", "login_math"));
                }
                else {
                    startActivity(new Intent(LoginMathActivity.this, LoginYoutubePlayerActivity.class)
                            .putExtra("video_id", youtubeVideoModelArrayList.get(position).getVideoId())
                            .putExtra("video_title", youtubeVideoModelArrayList.get(position).getTitle())
                            .putExtra("video_duration", youtubeVideoModelArrayList.get(position).getDuration())
                            .putExtra("username", _username).putExtra("password", _password));
    ...
    private ArrayList<YoutubeVideoModel> generateDummyVideoList() {
        ...
        String[] videoIDArray = getResources().getStringArray(R.array.math_video_id_array);
        String[] videoTitleArray = getResources().getStringArray(R.array.math_video_title_array);
        String[] videoDurationArray = getResources().getStringArray(R.array.math_video_duration_array);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.login_math, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.app_bar_switch) {
            startActivity(new Intent(LoginMathActivity.this, LoginMainActivity.class)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mathematics) {
            startActivity(new Intent(LoginMathActivity.this, LoginMathActivity.class)
                    .putExtra("_username", _username).putExtra("_password", _password)
                    .putExtra("_name_surname", _name_surname).putExtra("_email", _email));
        } else if (id == R.id.nav_engineering) {
            startActivity(new Intent(LoginMathActivity.this, LoginEngineeringActivity.class)
                    .putExtra("_username", _username).putExtra("_password", _password)
                    .putExtra("_name_surname", _name_surname).putExtra("_email", _email));
        } else if (id == R.id.nav_science) {
            startActivity(new Intent(LoginMathActivity.this, LoginScienceActivity.class)
                    .putExtra("_username", _username).putExtra("_password", _password)
                    .putExtra("_name_surname", _name_surname).putExtra("_email", _email));
        } else if (id == R.id.nav_favorites) {
            startActivity(new Intent(LoginMathActivity.this, FavoritesActivity.class)
            ...
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    editor.commit();
                    ActivityCompat.finishAffinity(LoginMathActivity.this);
                }
            });

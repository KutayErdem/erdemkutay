...
public class LoginEngineeringActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_engineering);
        setUpRecyclerView();
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                startActivity(new Intent(LoginEngineeringActivity.this, EngineeringActivity.class));
            }
        });
    }
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewOnClickListener(this, new RecyclerViewOnClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (isfavs.contains( _username + _password + youtubeVideoModelArrayList.get(position).getVideoId())){
                    startActivity(new Intent(LoginEngineeringActivity.this, FavoritesPlayerActivity.class)
                            ...
                            .putExtra("activity_name", "login_engineering"));
                }
                else {
                    startActivity(new Intent(LoginEngineeringActivity.this, LoginYoutubePlayerActivity.class)
                            .putExtra("video_id", youtubeVideoModelArrayList.get(position).getVideoId())
                            .putExtra("video_title", youtubeVideoModelArrayList.get(position).getTitle())
                            .putExtra("video_duration", youtubeVideoModelArrayList.get(position).getDuration())
                            .putExtra("username", _username).putExtra("password", _password));
    ...
    private ArrayList<YoutubeVideoModel> generateDummyVideoList() {
        ...
        String[] videoIDArray = getResources().getStringArray(R.array.engineering_video_id_array);
        String[] videoTitleArray = getResources().getStringArray(R.array.engineering_video_title_array);
        String[] videoDurationArray = getResources().getStringArray(R.array.engineering_video_duration_array);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.login_engineering, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.app_bar_switch) {
            startActivity(new Intent(LoginEngineeringActivity.this, LoginMainActivity.class)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mathematics) {
            startActivity(new Intent(LoginEngineeringActivity.this, LoginMathActivity.class)
                    .putExtra("_username", _username).putExtra("_password", _password)
                    .putExtra("_name_surname", _name_surname).putExtra("_email", _email));
        } else if (id == R.id.nav_engineering) {
            startActivity(new Intent(LoginEngineeringActivity.this, LoginEngineeringActivity.class)
                    .putExtra("_username", _username).putExtra("_password", _password)
                    .putExtra("_name_surname", _name_surname).putExtra("_email", _email));
        } else if (id == R.id.nav_science) {
            startActivity(new Intent(LoginEngineeringActivity.this, LoginScienceActivity.class)
                    .putExtra("_username", _username).putExtra("_password", _password)
                    .putExtra("_name_surname", _name_surname).putExtra("_email", _email));
        } else if (id == R.id.nav_favorites) {
            startActivity(new Intent(LoginEngineeringActivity.this, FavoritesActivity.class)
            ...
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    editor.commit();
                    ActivityCompat.finishAffinity(LoginEngineeringActivity.this);
                }
            });

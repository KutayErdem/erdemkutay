...
public class EngineeringActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (sharedpreferences.contains(username.getText().toString()) &&
                    ...
                    if (sharuser.equals(sharpass)) {
                        ...
                        startActivity(new Intent(EngineeringActivity.this, LoginEngineeringActivity.class)
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EngineeringActivity.this, SignActivity.class));
            }
        });
    }
    ...
    private void populateRecyclerView() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewOnClickListener(this, new RecyclerViewOnClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(EngineeringActivity.this, YoutubePlayerActivity.class)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.engineering, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.app_bar_switch) {
            startActivity(new Intent(EngineeringActivity.this, MainActivity.class));
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mathematics) {
            startActivity(new Intent(EngineeringActivity.this, MathActivity.class));
        } else if (id == R.id.nav_engineering) {
            startActivity(new Intent(EngineeringActivity.this, EngineeringActivity.class));
        } else if (id == R.id.nav_science) {
            startActivity(new Intent(EngineeringActivity.this, ScienceActivity.class));
            ...
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ActivityCompat.finishAffinity(EngineeringActivity.this);
                }
            });

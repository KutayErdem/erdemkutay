...
public class ScienceActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (sharedpreferences.contains(username.getText().toString()) &&
                    ...
                    if (sharuser.equals(sharpass)) {
                        ...
                        startActivity(new Intent(ScienceActivity.this, LoginScienceActivity.class)
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ScienceActivity.this, SignActivity.class));
            }
        });
    }
    ...
    private void populateRecyclerView() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewOnClickListener(this, new RecyclerViewOnClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(ScienceActivity.this, YoutubePlayerActivity.class)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.app_bar_switch) {
            startActivity(new Intent(ScienceActivity.this, MainActivity.class));
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mathematics) {
            startActivity(new Intent(ScienceActivity.this, MathActivity.class));
        } else if (id == R.id.nav_engineering) {
            startActivity(new Intent(ScienceActivity.this, EngineeringActivity.class));
        } else if (id == R.id.nav_science) {
            startActivity(new Intent(ScienceActivity.this, ScienceActivity.class));
            ...
            alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ActivityCompat.finishAffinity(ScienceActivity.this);
                }
            });
